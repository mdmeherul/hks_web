...
if( !class_exists( 'Xoha_Shop_Others_Quantity_Plus_Minus' ) ) {

    class Xoha_Shop_Others_Quantity_Plus_Minus {
        ...
        function __construct() {
            ...
            // JS
                add_action( 'xoha_after_woo_js', array ( $this, 'after_woo_js' ) );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/others/quantity-plus-minus/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/others/quantity-plus-minus/';
                } else {
        ...
        */
            function after_woo_js() {
                ...
                if( !is_product() && !is_cart() ) {
                    ...
                    wp_register_script( 'xoha-woo-quantity-plus-minus', '', array ('jquery'), false, true );
                    wp_enqueue_script( 'xoha-woo-quantity-plus-minus' );
                    ...
                    if( !empty($js) ) {
                        wp_add_inline_script( 'xoha-woo-quantity-plus-minus', $js );
                    }
...
if( !function_exists('xoha_shop_others_quantity_plus_minus') ) {
	function xoha_shop_others_quantity_plus_minus() {
        $reflection = new ReflectionClass('Xoha_Shop_Others_Quantity_Plus_Minus');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Shop_Others_Quantity_Plus_Minus::instance();