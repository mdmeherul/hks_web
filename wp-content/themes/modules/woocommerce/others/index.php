...
if( !class_exists( 'Xoha_Woo_Others' ) ) {

    class Xoha_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'xoha_woo_others_settings', $this->settings );
...
if( !function_exists('xoha_woo_others') ) {
	function xoha_woo_others() {
		return Xoha_Woo_Others::instance();
	}
}
