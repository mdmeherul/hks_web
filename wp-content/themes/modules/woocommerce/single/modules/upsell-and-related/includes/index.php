...
if( ! function_exists( 'xoha_shop_woo_show_upsell' ) ) {

	function xoha_shop_woo_show_upsell() {

		global $product;

        $settings = xoha_woo_single_core()->woo_default_settings();
        $settings = apply_filters( 'xoha_woo_single_upsell_related_settings', $settings );

		if( $settings['product_upsell_display'] ) {

			xoha_shop_single_module_upsell_related()->woo_load_listing( $settings['product_upsell_style_template'], $settings['product_upsell_style_custom_template'] );
	...
	add_action( 'woocommerce_after_single_product_summary', 'xoha_shop_woo_show_upsell', 15 );
...
if( ! function_exists( 'xoha_shop_woo_show_related_products' ) ) {

	function xoha_shop_woo_show_related_products() {
	...
	add_action( 'woocommerce_after_single_product_summary', 'xoha_shop_woo_show_related_products', 20 );
...
if( ! function_exists( 'xoha_shop_woo_single_upsell_related_settings' ) ) {

	function xoha_shop_woo_single_upsell_related_settings( $settings ) {
        ...
        if( isset( $custom_settings['show-upsell'] ) && $custom_settings['show-upsell'] == 'admin-option' ) {
            ...
            $settings['product_upsell_display'] = xoha_customizer_settings('wdt-single-product-upsell-display' );
            $settings['product_upsell_column']  = xoha_customizer_settings('wdt-single-product-upsell-column' );
            $settings['product_upsell_limit']   = xoha_customizer_settings('wdt-single-product-upsell-limit' );
        ...
        $product_upsell_style_custom_template = xoha_customizer_settings('wdt-single-product-upsell-style-template' );
        ...
        if( isset( $custom_settings['show-related'] ) && $custom_settings['show-related'] == 'admin-option' ) {
            ...
            $settings['product_related_display'] = xoha_customizer_settings('wdt-single-product-related-display' );
            $settings['product_related_column']  = xoha_customizer_settings('wdt-single-product-related-column' );
            $settings['product_related_limit']   = xoha_customizer_settings('wdt-single-product-related-limit' );
        ...
        $product_related_style_custom_template = xoha_customizer_settings('wdt-single-product-related-style-template' );
	...
	add_filter( 'xoha_woo_single_upsell_related_settings', 'xoha_shop_woo_single_upsell_related_settings', 10, 1 );
...
if( ! function_exists( 'xoha_shop_product_style_reset_loop_prop' ) ) {

	function xoha_shop_product_style_reset_loop_prop() {
...
if( ! function_exists( 'xoha_shop_woo_related_products_heading' ) ) {

	function xoha_shop_woo_related_products_heading($heading) {
		...
		if( ( $product_template == 'custom-template' && $product_related_hide_title != 'true' ) || $product_template == 'woo-default' ) {
			...
			$title = xoha_customizer_settings( 'wdt-single-product-related-title' );
	...
	add_filter( 'woocommerce_product_related_products_heading', 'xoha_shop_woo_related_products_heading', 1 );
...
if( ! function_exists( 'xoha_shop_woo_upsells_products_heading' ) ) {

	function xoha_shop_woo_upsells_products_heading($heading) {
		...
		if( ( $product_template == 'custom-template' && $product_upsell_hide_title != 'true' ) || $product_template == 'woo-default' ) {
			...
			$title = xoha_customizer_settings( 'wdt-single-product-upsell-title' );
            $heading = ( isset($title) && !empty($title) ) ? $title : $heading;
	...
	add_filter( 'woocommerce_product_upsells_products_heading', 'xoha_shop_woo_upsells_products_heading', 1 );
