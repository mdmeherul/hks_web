...
if( !class_exists( 'Xoha_Shop_Single_Module_Upsell_Related' ) ) {

    class Xoha_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'xoha_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('xoha_shop_single_module_upsell_related') ) {
	function xoha_shop_single_module_upsell_related() {
		return Xoha_Shop_Single_Module_Upsell_Related::instance();
	}
}

xoha_shop_single_module_upsell_related();