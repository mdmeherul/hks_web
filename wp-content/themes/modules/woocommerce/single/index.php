...
if( !class_exists( 'Xoha_Woo_Single_core' ) ) {

    class Xoha_Woo_Single_core {
        ...
        function __construct() {
            ...
            // Enqueue CSS
                add_action( 'xoha_after_woo_css', array ( $this, 'after_woo_css' ), 10 );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/single/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/single/';
                } else {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'xoha_woo_single_page_settings', $this->settings );
        ...
        */
            function load_modules() {
                ...
                include_once XOHA_MODULE_DIR. '/woocommerce/single/includes/template.php';
                include_once XOHA_MODULE_DIR. '/woocommerce/single/includes/labels.php';
            ...
            function load_custom_modules() {
                ...
                if( is_array( $custom_modules ) && !empty( $custom_modules ) ) {
                    foreach( $custom_modules as $custom_module ) {
                        ...
                        if( $file_path = xoha_woo_locate_file( $custom_module ) ) {
        ...
        */
            function after_woo_css() {
                ...
                if( is_product() ) {
                    wp_enqueue_style('xoha-woo-single-common', $this->module_dir_url() . 'assets/css/common.css');
                }
...
if( !function_exists('xoha_woo_single_core') ) {
	function xoha_woo_single_core() {
        $reflection = new ReflectionClass('Xoha_Woo_Single_core');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Woo_Single_core::instance();