...
if( !class_exists( 'Xoha_Woo_Listing_Tag' ) ) {

    class Xoha_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'xoha_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('xoha_woo_listing_tag') ) {
	function xoha_woo_listing_tag() {
		return Xoha_Woo_Listing_Tag::instance();
	}
}

xoha_woo_listing_tag();