...
function xoha_shop_woo_loop_product_thumb_content_setup($product_thumb_contents) {
	...
	if(!empty($product_thumb_contents)) {
		...
		foreach($product_thumb_contents as $product_thumb_content) {
			...
			add_action('xoha_woo_loop_product_thumb_content', 'xoha_shop_woo_loop_product_content_'.$product_thumb_content, $i, 1);
...
function xoha_shop_woo_loop_product_content_content_setup($product_content_contents) {
	...
	if(!empty($product_content_contents)) {
		...
		foreach($product_content_contents as $product_content_content) {
			...
			add_action('xoha_woo_loop_product_content_content', 'xoha_shop_woo_loop_product_content_'.$product_content_content, $i, 1);
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_title' ) ) {

	function xoha_shop_woo_loop_product_content_title() {

		global $product;
		echo '<div class="product-title"><h5><a href="'.esc_url($product->get_permalink()).'">'.xoha_html_output($product->get_name()).'</a></h5></div>';
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_excerpt' ) ) {

	function xoha_shop_woo_loop_product_content_excerpt() {

		global $product;
		if($product->get_short_description() != '') {
			echo '<div class="product-short-description">'.xoha_html_output($product->get_short_description()).'</div>';
		}
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_rating' ) ) {

	function xoha_shop_woo_loop_product_content_rating() {
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_category' ) ) {

	function xoha_shop_woo_loop_product_content_category() {
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_price' ) ) {

	function xoha_shop_woo_loop_product_content_price() {
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_button_element' ) ) {

	function xoha_shop_woo_loop_product_content_button_element($location) {
		...
		if($product_buttonelement_button) {
			...
			if($product_buttonelement_button == 'cart-with-quantity') {
				...
				if ( $product && $product->is_type( 'simple' ) ) {
					do_action( 'xoha_woo_loop_product_button_elements_cart_with_quantity' );
				} else {
					echo '<div class="product-buttons-wrapper product-button">';
						echo '<div class="wc_inline_buttons">';
							do_action( 'xoha_woo_loop_product_button_elements_cart' );
						echo '</div>';
					echo '</div>';
				}
			} else {
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_countdown' ) ) {

	function xoha_shop_woo_loop_product_content_countdown() {
		...
		if($countdown != '') {
			echo '<div class="product-countdown-wrapper">'.xoha_html_output($countdown).'</div>';
		}
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_swatches' ) ) {

	function xoha_shop_woo_loop_product_content_swatches() {
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_product_notes' ) ) {

	function xoha_shop_woo_loop_product_content_product_notes() {
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_icons_group' ) ) {

	function xoha_shop_woo_loop_product_content_icons_group($location) {
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_separator' ) ) {

	function xoha_shop_woo_loop_product_content_separator() {
...
if( ! function_exists( 'xoha_shop_woo_loop_product_content_element_group' ) ) {

	function xoha_shop_woo_loop_product_content_element_group($location) {
		...
		if($product_element_group) {
			...
			echo '<div class="product-element-group-wrapper">';
				...
				if(in_array('title', $product_element_group)) {
					ob_start();
					xoha_shop_woo_loop_product_content_title();
					$title = ob_get_clean();
				}
				...
				if(in_array('price', $product_element_group)) {
					ob_start();
					xoha_shop_woo_loop_product_content_price();
					$price = ob_get_clean();
				}
				...
				if(in_array('category', $product_element_group)) {
					ob_start();
					xoha_shop_woo_loop_product_content_category();
				...
				if(in_array('button_element', $product_element_group)) {
					ob_start();
					xoha_shop_woo_loop_product_content_button_element($location);
				...
				if(in_array('icons_group', $product_element_group)) {
					ob_start();
					xoha_shop_woo_loop_product_content_icons_group($location);
				...
				if(in_array('excerpt', $product_element_group)) {
					ob_start();
					xoha_shop_woo_loop_product_content_excerpt();
				...
				if(in_array('rating', $product_element_group)) {
					ob_start();
					xoha_shop_woo_loop_product_content_rating();
					$rating = ob_get_clean();
				}
				...
				if(in_array('separator', $product_element_group)) {
					ob_start();
					xoha_shop_woo_loop_product_content_separator();
...
if( ! function_exists( 'xoha_shop_after_shop_loop_quick_view' ) ) {

	function xoha_shop_after_shop_loop_quick_view($location) {
	...
	add_action( 'template_redirect', 'xoha_shop_after_shop_loop_quick_view' );
	add_action( 'admin_init', 'xoha_shop_after_shop_loop_quick_view' );
