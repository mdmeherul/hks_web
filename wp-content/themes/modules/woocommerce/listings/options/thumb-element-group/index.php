...
if( !class_exists( 'Xoha_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class Xoha_Woo_Listing_Option_Thumb_Element_Group extends Xoha_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'xoha_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('xoha_woo_listing_option_thumb_element_group') ) {
	function xoha_woo_listing_option_thumb_element_group() {
		return Xoha_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

xoha_woo_listing_option_thumb_element_group();