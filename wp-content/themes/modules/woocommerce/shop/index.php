...
if( !class_exists( 'Xoha_Woo_Listing_Shop' ) ) {

    class Xoha_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'xoha_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('xoha_woo_listing_shop') ) {
	function xoha_woo_listing_shop() {
		return Xoha_Woo_Listing_Shop::instance();
	}
}

xoha_woo_listing_shop();