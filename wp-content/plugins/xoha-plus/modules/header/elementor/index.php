...
if( !class_exists( 'XohaPlusHeaderElementor' ) ) {
    class XohaPlusHeaderElementor {
        ...
        function frontend() {
            add_filter( 'xoha_print_header_template', array( $this, 'register_header_template' ), 10, 1 );
        }
		...
		function register_header_template( $id ) {
            ...
            return apply_filters( 'xoha_plus_header_content', $content );
		}
    }
}

XohaPlusHeaderElementor::instance();