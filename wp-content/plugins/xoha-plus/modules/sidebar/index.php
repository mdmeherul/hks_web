...
if( !class_exists( 'XohaPlusSidebar' ) ) {
    class XohaPlusSidebar {
        ...
        function load_modules() {
            include_once XOHA_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('xoha_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('xoha_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
