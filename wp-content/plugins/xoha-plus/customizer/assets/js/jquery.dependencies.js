;(function ( $, window, document, undefined ) {
    'use strict';
    $.XOHAPLUSWPCUSTOMIZER = $.XOHAPLUSWPCUSTOMIZER || {};

	$.XOHAPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.XOHAPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.XOHAPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').XOHAPLUSWPCUSTOMIZER_DEPENDENCY();
	});
