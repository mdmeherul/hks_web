...
class Xoha_Customize_Control_Slider extends WP_Customize_Control {
	...
	*/
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'xoha-plus-slider-control', XOHA_PLUS_DIR_URL.'customizer/controls/slider/slider.js', array( 'jquery', 'customize-base' ), XOHA_PLUS_VERSION, true );
		wp_enqueue_style( 'xoha-plus-slider-control',  XOHA_PLUS_DIR_URL.'customizer/controls/slider/slider.css', null, XOHA_PLUS_VERSION );
	}
