...
class Xoha_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'xoha-plus-separator-control',  XOHA_PLUS_DIR_URL.'customizer/controls/separator/separator.css', null, XOHA_PLUS_VERSION );
	}
