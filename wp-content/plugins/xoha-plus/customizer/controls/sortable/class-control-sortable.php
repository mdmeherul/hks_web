...
class Xoha_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'xoha-plus-sortable-control', XOHA_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), XOHA_PLUS_VERSION, true );
		wp_enqueue_style( 'xoha-plus-sortable-control',  XOHA_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, XOHA_PLUS_VERSION );
	}
