...
class Xoha_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'xoha-plus-description-control',  XOHA_PLUS_DIR_URL.'customizer/controls/description/description.css', null, XOHA_PLUS_VERSION );
	}
