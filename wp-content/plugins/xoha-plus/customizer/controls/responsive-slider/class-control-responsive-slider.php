...
class Xoha_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'xoha-plus-responsive-slider-control', XOHA_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), XOHA_PLUS_VERSION, true );
		wp_enqueue_style( 'xoha-plus-responsive-slider-control',  XOHA_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.css', null, XOHA_PLUS_VERSION );
	}
