...
class Xoha_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'xoha-plus-color-control', XOHA_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'xoha-plus-customizer-color-picker' ), XOHA_PLUS_VERSION, true );
		wp_enqueue_style( 'xoha-plus-color-control',  XOHA_PLUS_DIR_URL.'customizer/controls/color/color.css', null, XOHA_PLUS_VERSION );
	}
