...
class Xoha_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'xoha-plus-fontawesome-control', XOHA_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), XOHA_PLUS_VERSION, true );
		wp_enqueue_style( 'xoha-plus-fontawesome-control',  XOHA_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, XOHA_PLUS_VERSION );

		wp_enqueue_style( 'xoha-plus-fontawesome',  XOHA_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),XOHA_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "xoha-plus") .' '.esc_html( $this->label );
