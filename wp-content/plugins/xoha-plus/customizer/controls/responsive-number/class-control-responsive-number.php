...
class Xoha_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'xoha-plus-responsive-number-control', XOHA_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), XOHA_PLUS_VERSION, true );
		wp_enqueue_style( 'xoha-plus-responsive-number-control',  XOHA_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, XOHA_PLUS_VERSION );
	}
