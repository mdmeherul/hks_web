...
class Xoha_Customize_Control_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'xoha-plus-spacing-control', XOHA_PLUS_DIR_URL.'customizer/controls/spacing/spacing.js', array( 'jquery', 'customize-base' ), XOHA_PLUS_VERSION, true );
		wp_enqueue_style( 'xoha-plus-spacing-control',  XOHA_PLUS_DIR_URL.'customizer/controls/spacing/spacing.css', null, XOHA_PLUS_VERSION );
	}
