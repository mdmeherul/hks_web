...
class Xoha_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'xoha-plus-radio-image-control', XOHA_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), XOHA_PLUS_VERSION, true );
		wp_enqueue_style( 'xoha-plus-radio-image-control',  XOHA_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, XOHA_PLUS_VERSION );
	}
