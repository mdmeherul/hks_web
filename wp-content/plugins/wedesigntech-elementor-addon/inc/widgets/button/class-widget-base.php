							...
							'normal' => array (
								...
								'styles' => array (
									'color' => array (
										'field_type' => 'color',
										'selector' => array (
											'{{WRAPPER}} .wdt-button-holder .wdt-button' => 'color: {{VALUE}};'
										),
										'condition' => array ()
									),
									'border' => array (
							...
							'hover' => array (
								...
								'styles' => array (
									'color' => array (
										'field_type' => 'color',
										'selector' => array (
											'{{WRAPPER}} .wdt-button-holder .wdt-button:focus, {{WRAPPER}} .wdt-button-holder .wdt-button:hover' => 'color: {{VALUE}};'
										),
										'condition' => array ()
									),
									'border' => array (
							...
							'hover' => array (
								...
								'styles' => array (
									'color' => array (
										'field_type' => 'color',
										'selector' => array (
											'{{WRAPPER}} .wdt-button-holder .wdt-button:focus .wdt-button-icon, {{WRAPPER}} .wdt-button-holder .wdt-button:hover .wdt-button-icon' => 'color: {{VALUE}};'
										),
										'condition' => array ()
									),
									'background' => array (
