	...
	public function create_elementor_controls($elementor_object) {
		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'on_click_element_icon', array (
				...
				'condition' => array(
					'trigger_type' => 'on-click',
					'on_click_element' => array ('icon', 'label-n-icon'),
				)
			));
		...
		// Trigger Element
			$this->cc_style->get_style_controls($elementor_object, array (
				...
				'condition' => array(
					'trigger_type' => 'on-click',
					'on_click_element' => array ( 'label', 'label-n-icon', 'image' )
				),
				'styles' => array (
					'alignment' => array (
			...
			$this->cc_style->get_style_controls($elementor_object, array (
				...
				'styles' => array (
					'alignment' => array (
						'field_type' => 'alignment',
						'selector' => array (
							'.wdt-popup-box-window-{{ID}} .wdt-popup-box-content-holder.wdt-content-type-content' => 'text-align: {{VALUE}}; justify-content: {{VALUE}}; justify-items: {{VALUE}};'
						),
						'condition' => array ()
					),
					'typography' => array (
						'field_type' => 'typography',
						'selector' => '.wdt-popup-box-window-{{ID}} .wdt-popup-box-content-holder.wdt-content-type-content',
						'condition' => array ()
					),
					'margin' => array (
						'field_type' => 'margin',
					...
					'padding' => array (
						'field_type' => 'padding',
						'selector' => array (
							'.wdt-popup-box-window-{{ID}} .wdt-popup-box-content-holder' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
						'condition' => array ()
					),
					'width' => array (
						...
						'selector' => array (
							'.wdt-popup-box-window-{{ID}} .wdt-popup-box-content-holder' => 'width: {{SIZE}}{{UNIT}};'
						),
						'condition' => array ()
					),
					'color' => array (
						'field_type' => 'color',
						'selector' => array (
							'.wdt-popup-box-window-{{ID}} .wdt-popup-box-content-holder.wdt-content-type-content' => 'color: {{VALUE}};'
						),
						'condition' => array ()
					),
					'background' => array (
						...
						'color_selector' => array(
							'.wdt-popup-box-window-{{ID}} .wdt-popup-box-content-holder' => 'background-color: {{VALUE}};'
						),
						'condition' => array ()
					),
					'border' => array (
						...
						'selector' => '.wdt-popup-box-content-holder-{{ID}}',
						'color_selector' => array (
							'.wdt-popup-box-window-{{ID}} .wdt-popup-box-content-holder' => 'border-color: {{VALUE}};'
						),
						'condition' => array ()
					),
					'border_radius' => array (
						'field_type' => 'border_radius',
						'selector' => array (
							'.wdt-popup-box-window-{{ID}} .wdt-popup-box-content-holder' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
						'condition' => array ()
					),
					'box_shadow' => array (
						'field_type' => 'box_shadow',
						'selector' => '.wdt-popup-box-window-{{ID}} .wdt-popup-box-content-holder',
						'condition' => array ()
					)
				)
			));
			...
			if(isset($settings['on_click_element_image']['url']) || isset($settings['on_click_element_label']) || isset($settings['on_click_element_icon']['value'])) {
				$output .= '<div class="wdt-popup-box-trigger-element">';
					if(isset($settings['on_click_element_image']['url'])) {
						$output .= '<img src="'.esc_url($settings['on_click_element_image']['url']).'" class="wdt-popup-box-trigger-item wdt-popup-box-trigger-image">';
					}
