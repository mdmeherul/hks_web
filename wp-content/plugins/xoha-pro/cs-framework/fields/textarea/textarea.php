...
class CSFramework_Option_textarea extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<textarea name="'. esc_attr($this->element_name()) .'"'. xoha_html_output($this->element_class()) . $this->element_attributes() .'>'. $this->element_value() .'</textarea>';
  ...
  public function shortcode_generator() {
    if( isset( $this->field['shortcode'] ) && CS_ACTIVE_SHORTCODE ) {
      echo '<a href="#" class="button button-primary cs-shortcode cs-shortcode-textarea">'. esc_html__( 'Add Shortcode', 'xoha-pro' ) .'</a>';
    }
  }
}
