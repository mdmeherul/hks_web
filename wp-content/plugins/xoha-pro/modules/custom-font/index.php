...
if( !class_exists( 'XohaProCustomFont' ) ) {
    class XohaProCustomFont {
        ...
        function load_modules() {
            include_once XOHA_PRO_DIR_PATH.'modules/custom-font/taxonomy/index.php';
        }

        function load_customizer(){
            add_filter( 'xoha_customizer_custom_fonts', array( $this, 'fonts_list' ), 20 );
        }
        ...
        function elementor_group( $font_groups ) {
            ...
            if( count( $fonts ) > 0 ) {
                $new_group[ 'xoha_custom_fonts' ] = esc_html__( 'Custom Font', 'xoha-pro' );
        ...
        function load_frontend() {
            add_filter( 'xoha_add_inline_style', array( $this, 'custom_font_style' ) );
        }
        ...
        function get_fonts() {
            ...
            $fonts = array();
            $terms = get_terms( 'xoha_custom_fonts', array( 'hide_empty' => false ) );
        ...
        function get_font_links( $id ) {
            $meta = get_term_meta( $id, '_xoha_custom_font_options', true );
