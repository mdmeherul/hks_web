...
class Xoha_Shop_Widget_Product_Cat extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Categories', 'xoha-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'product_cat_section', array(
			...
			$this->add_control( 'columns', array(
				...
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					1  => esc_html__('I Column', 'xoha-pro'),
					2  => esc_html__('II Columns', 'xoha-pro'),
					3  => esc_html__('III Columns', 'xoha-pro')
				),
				'description' => esc_html__( 'Number of columns you like to display your taxonomies.', 'xoha-pro' ),
				'default'      => 3,
			) );
			...
			$this->add_control( 'include', array(
				...
				'description' => esc_html__( 'Category ids separated by comma.', 'xoha-pro' ),
				'default' => ''
			) );
