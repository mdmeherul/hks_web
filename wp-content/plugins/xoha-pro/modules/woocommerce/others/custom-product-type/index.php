...
if( !class_exists( 'Xoha_Shop_Others_Custom_Product_Type' ) ) {

    class Xoha_Shop_Others_Custom_Product_Type {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/others/custom-product-type/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/others/custom-product-type/';
                } else {
...
if( !function_exists('xoha_shop_others_custom_product_type') ) {
	function xoha_shop_others_custom_product_type() {
        $reflection = new ReflectionClass('Xoha_Shop_Others_Custom_Product_Type');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Shop_Others_Custom_Product_Type::instance();