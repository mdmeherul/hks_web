...
if( !class_exists( 'Xoha_Shop_Others_Wishlist' ) ) {

    class Xoha_Shop_Others_Wishlist {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/others/wishlist/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/others/wishlist/';
                } else {
...
if( !function_exists('xoha_shop_others_wishlist') ) {
	function xoha_shop_others_wishlist() {
        $reflection = new ReflectionClass('Xoha_Shop_Others_Wishlist');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Shop_Others_Wishlist::instance();