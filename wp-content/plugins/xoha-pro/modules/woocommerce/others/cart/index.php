...
if( !class_exists( 'Xoha_Shop_Others_Cart' ) ) {

    class Xoha_Shop_Others_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/others/cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/others/cart/';
                } else {
...
if( !function_exists('xoha_shop_others_cart') ) {
	function xoha_shop_others_cart() {
        $reflection = new ReflectionClass('Xoha_Shop_Others_Cart');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Shop_Others_Cart::instance();