...
if( !class_exists( 'Xoha_Shop_Others_Size_Guide' ) ) {

    class Xoha_Shop_Others_Size_Guide {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/others/size-guide/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/others/size-guide/';
                } else {
...
if( !function_exists('xoha_shop_others_size_guide') ) {
	function xoha_shop_others_size_guide() {
        $reflection = new ReflectionClass('Xoha_Shop_Others_Size_Guide');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Shop_Others_Size_Guide::instance();