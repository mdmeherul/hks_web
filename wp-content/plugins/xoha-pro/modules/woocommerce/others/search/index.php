...
if( !class_exists( 'Xoha_Shop_Others_Search' ) ) {

    class Xoha_Shop_Others_Search {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/others/search/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/others/search/';
                } else {
         ...
         */
            function module_add_new_page_template( $templates ) {
                ...
                $templates = array_merge (
                    $templates,
                    array (
                        'tpl-product-search-listing.php' => esc_html__('Product Search Listing Template', 'xoha-pro')
                    )
                );
...
if( !function_exists('xoha_shop_others_search') ) {
	function xoha_shop_others_search() {
        $reflection = new ReflectionClass('Xoha_Shop_Others_Search');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Shop_Others_Search::instance();