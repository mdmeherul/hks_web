...
if( !class_exists( 'Xoha_Shop_Others_Recently_Viewed_Products_Include' ) ) {

    class Xoha_Shop_Others_Recently_Viewed_Products_Include {
        ...
        function __construct() {
			...
			add_action( 'xoha_hook_bottom', array( $this, 'xoha_shop_recently_viewed_products_content' ) );
			add_action( 'wp', array( $this, 'xoha_shop_set_recently_viewed_products' ) );
         ...
         */
			function xoha_shop_recently_viewed_products_content() {
				...
				if($enable_recently_viewed_products) {
					...
					if(!empty($viewed_products)) {
						...
						if ( $products->have_posts() ) {
							...
							echo '<div class="wdt-shop-recently-viewed-products-holder expand">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
									...
									echo '<div class="wdt-shop-recently-viewed-products-title">';
										echo esc_html__('Recently Viewed', 'xoha-pro');
									echo '</div>';
												...
												echo '<div class="wdt-shop-recently-viewed-product swiper-slide">';
													...
													echo '<div class="wdt-shop-recently-viewed-product-info">';
														...
														if( !empty($add_to_cart) ) {
															...
															echo '<div class="wcct_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Add To Cart', 'xoha-pro' ).'">'.xoha_html_output($add_to_cart).'</div>';
						...
						echo '<div class="wdt-shop-recently-viewed-products-holder expand">';
							...
							echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-container">';
									echo esc_html__('Sorry, there are no products.', 'xoha-pro');
								echo '</div>';
         ...
         */
			function xoha_shop_set_recently_viewed_products() {
				if(is_product()) {
...
if( !function_exists('xoha_shop_others_recently_viewed_products_include') ) {
	function xoha_shop_others_recently_viewed_products_include() {
        $reflection = new ReflectionClass('Xoha_Shop_Others_Recently_Viewed_Products_Include');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Shop_Others_Recently_Viewed_Products_Include::instance();