...
if( !class_exists( 'Xoha_Shop_Others_Recently_Viewed_Products' ) ) {

    class Xoha_Shop_Others_Recently_Viewed_Products {
        ...
        function __construct() {
            ...
            // Enqueue CSS
                add_action( 'xoha_before_woo_css', array ( $this, 'before_woo_css' ), 10 );

            // Enqueue JS
                add_action( 'xoha_before_woo_js', array ( $this, 'before_woo_js' ), 10 );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/others/recently-viewed-products/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/others/recently-viewed-products/';
                } else {
...
if( !function_exists('xoha_shop_others_recently_viewed_products') ) {
	function xoha_shop_others_recently_viewed_products() {
        $reflection = new ReflectionClass('Xoha_Shop_Others_Recently_Viewed_Products');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Shop_Others_Recently_Viewed_Products::instance();