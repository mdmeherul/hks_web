...
if( !class_exists( 'Xoha_Woo_Listing_Type_Custom' ) ) {

    class Xoha_Woo_Listing_Type_Custom {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Custom', 'xoha-pro');
        ...
        */
            function set_type_options() {
                ...
                if( strpos($this->custom_template, 'predefined-template-') !== false ) {
                    ...
                    $field_key = str_replace('predefined-template-', 'xoha-woo-product-style-template-',  $this->custom_template);
                    ...
                    $custom_options = ( isset($dtcs_product_templates['xoha-woo-product-style-templates'][$field_key]) && !empty($dtcs_product_templates['xoha-woo-product-style-templates'][$field_key]) ) ? $dtcs_product_templates['xoha-woo-product-style-templates'][$field_key] : array ();
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'xoha-woo-non-archive', '', array (), XOHA_PRO_VERSION, 'all' );
...
if( !function_exists('xoha_woo_listing_type_custom') ) {
	function xoha_woo_listing_type_custom() {
		return Xoha_Woo_Listing_Type_Custom::instance();
	}
}

xoha_woo_listing_type_custom();