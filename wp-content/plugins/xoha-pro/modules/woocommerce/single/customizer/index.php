...
if( !class_exists( 'Xoha_Pro_Customizer_Single' ) ) {

    class Xoha_Pro_Customizer_Single {
        ...
        function default( $option ) {
            ...
            $option['wdt-single-product-enable-breadcrumb']          = $product_enable_breadcrumb;
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_panel(
                new Xoha_Customize_Panel(
                    ...
                    array(
                        'title'    => esc_html__('Product Single Page', 'xoha-pro'),
                ...
                $wp_customize->add_section(
                    new Xoha_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Default Settings', 'xoha-pro'),
                ...
                $wp_customize->add_section(
                    new Xoha_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Upsell Settings', 'xoha-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 20,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Xoha_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Related Settings', 'xoha-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 30,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Xoha_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Share Settings', 'xoha-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 40,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Xoha_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Follow Settings', 'xoha-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 50,
                        )
                    )
...
if( !function_exists('xoha_customizer_single') ) {
	function xoha_customizer_single() {
		return Xoha_Pro_Customizer_Single::instance();
	}
}

xoha_customizer_single();