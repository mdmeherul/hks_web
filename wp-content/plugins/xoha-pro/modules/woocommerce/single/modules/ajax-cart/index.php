...
if( !class_exists( 'Xoha_Shop_Single_Module_Ajax_Cart' ) ) {

    class Xoha_Shop_Single_Module_Ajax_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/single/modules/ajax-cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/single/modules/ajax-cart/';
                } else {
...
if( !function_exists('xoha_shop_single_module_ajax_cart') ) {
	function xoha_shop_single_module_ajax_cart() {
		return Xoha_Shop_Single_Module_Ajax_Cart::instance();
	}
}

xoha_shop_single_module_ajax_cart();