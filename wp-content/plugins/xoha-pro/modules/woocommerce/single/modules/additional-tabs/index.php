...
if( !class_exists( 'Xoha_Shop_Single_Module_Additional_Tabs' ) ) {

    class Xoha_Shop_Single_Module_Additional_Tabs {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/single/modules/additional-tabs/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/single/modules/additional-tabs/';
                } else {
...
if( !function_exists('xoha_shop_single_module_additional_tabs') ) {
	function xoha_shop_single_module_additional_tabs() {
        $reflection = new ReflectionClass('Xoha_Shop_Single_Module_Additional_Tabs');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Xoha_Shop_Single_Module_Additional_Tabs::instance();