...
if( !class_exists( 'Xoha_Shop_Single_Module_Count_Down_Timer' ) ) {

    class Xoha_Shop_Single_Module_Count_Down_Timer {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/single/modules/count-down-timer/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/single/modules/count-down-timer/';
                } else {
...
if( !function_exists('xoha_shop_single_module_count_down_timer') ) {
	function xoha_shop_single_module_count_down_timer() {
        $reflection = new ReflectionClass('Xoha_Shop_Single_Module_Count_Down_Timer');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Xoha_Shop_Single_Module_Custom_template' ) ) {
    Xoha_Shop_Single_Module_Count_Down_Timer::instance();
}