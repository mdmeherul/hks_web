...
if( !class_exists( 'Xoha_Shop_Single_Module_Custom_template' ) ) {
    ...
    class Xoha_Shop_Single_Module_Custom_template {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/single/modules/custom-template/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/single/modules/custom-template/';
                } else {
...
if( !function_exists('xoha_shop_single_module_custom_template') ) {
	function xoha_shop_single_module_custom_template() {
		return Xoha_Shop_Single_Module_Custom_template::instance();
	}
}

xoha_shop_single_module_custom_template();