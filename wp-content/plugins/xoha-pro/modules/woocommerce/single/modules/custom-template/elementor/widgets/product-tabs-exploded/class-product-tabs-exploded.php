...
class Xoha_Shop_Widget_Product_Tabs_Exploded extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Tabs Exploded', 'xoha-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section( 'product_tabs_exploded_section', array(
			...
			$this->add_control( 'tab', array(
				...
				'default'     => 'description',
				'options'     => array(
					'description'            => esc_html__( 'Description', 'xoha-pro' ),
					'review'                 => esc_html__( 'Review', 'xoha-pro' ),
					'additional_information' => esc_html__( 'Additional Information', 'xoha-pro' )
				),
			) );
	...
	protected function render() {
		...
		$output = xoha_shop_product_tabs_exploded_render_html($settings);
