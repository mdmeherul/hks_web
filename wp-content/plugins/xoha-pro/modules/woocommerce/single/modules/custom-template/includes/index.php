...
if( ! function_exists( 'xoha_shop_woo_product_single_custom_template_option' ) ) {
	...
	function xoha_shop_woo_product_single_custom_template_option() {
...
if( ! function_exists( 'xoha_shop_woo_product_single_template' ) ) {

	function xoha_shop_woo_product_single_template( $single_template ) {

		if (is_singular( 'product' )) {

			$product_template = xoha_shop_woo_product_single_custom_template_option();

			if( $product_template == 'custom-template' ) {
				$single_template = xoha_shop_single_module_custom_template()->module_dir_path() . 'templates/custom-template.php';
			}
	...
	add_filter('template_include', 'xoha_shop_woo_product_single_template', 100);
