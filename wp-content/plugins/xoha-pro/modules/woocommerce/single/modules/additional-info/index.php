...
if( !class_exists( 'Xoha_Shop_Single_Module_Additional_Info' ) ) {

    class Xoha_Shop_Single_Module_Additional_Info {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_DIR . '/woocommerce/single/modules/additional-info/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( xoha_is_file_in_theme( __FILE__ ) ) {
                    return XOHA_MODULE_URI . '/woocommerce/single/modules/additional-info/';
                } else {
...
if( !function_exists('xoha_shop_single_module_additional_info') ) {
	function xoha_shop_single_module_additional_info() {
        $reflection = new ReflectionClass('Xoha_Shop_Single_Module_Additional_Info');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Xoha_Shop_Single_Module_Custom_template' ) ) {
    Xoha_Shop_Single_Module_Additional_Info::instance();
}