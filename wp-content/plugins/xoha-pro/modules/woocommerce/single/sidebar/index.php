...
if( !class_exists( 'Xoha_Pro_Woo_single_Sidebar' ) ) {
    class Xoha_Pro_Woo_single_Sidebar {
        ...
        function frontend() {
            ...
            add_filter('xoha_active_sidebars', array( $this, 'active_sidebars' ), 30 );
        }
        ...
        function primary_classes( $primary_class ) {
            ...
            if( is_product() ) {
                ...
                $settings = get_post_meta( $post_id, '_xoha_layout_settings', true );
...
Xoha_Pro_Woo_single_Sidebar::instance();