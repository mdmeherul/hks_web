...
class Elementor_Post_Likes_Views extends XohaElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Likes & Views', 'xoha-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-likes-views-wrapper '.$style.' '.$el_class.'">';
            $out .= xoha_get_template_part( 'post', 'templates/post-extra/likes_views', '', $template_args );
		$out .= '</div>';
