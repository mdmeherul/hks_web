...
function wdt_generate_load_search_data_ouput() {
	...
	// Custom Options
	$custom_options = json_decode(stripslashes(wdt_sanitize_fields($_REQUEST['custom_options'])), true);
	...
	$output .= '<div class="wdt-listings-container '.esc_attr($swiper_container_class).' '.esc_attr($isotope_class).' '.esc_attr($gallery_image_popup).'">';
		...
		if($apply_isotope == 'true' && $isotope_filter != '') {
			...
			if(is_array($filter_items) && !empty($filter_items)) {
		        $output .= '<div class="wdt-listings-item-isotope-filter">';
			        $output .= '<a href="#" class="active-sort" data-filter=".all-sort">'.esc_html__('All','wdt-portfolio').'</a>';
	...
	if($apply_isotope == 'true') {
		...
		if($type == 'type1') {
			...
			$output .= '<div class="wdt-listings-item-top-section">';
				...
				$gallery_images = (is_array($wdt_media_images_ids) && !empty($wdt_media_images_ids)) ? count($wdt_media_images_ids) : 0;
				...
				if($gallery == 'featured_image') {
					...
					$output .= '<div class="wdt-listings-item-image-gallery">';
						$output .= do_shortcode('[wdt_sp_media_images listing_id="'.esc_attr($listing_id).'" image_size="full" include_featured_image="false" carousel_paginationtype="" carousel_arrowpagination="true" carousel_loopmode="false" /]');
					$output .= '</div>';
					...
					$output .= '<div class="wdt-listings-item-image-gallery">';
						$output .= do_shortcode('[wdt_sp_media_images listing_id="'.esc_attr($listing_id).'" image_size="full" include_featured_image="true" carousel_loopmode="false" carousel_paginationtype="" carousel_arrowpagination="true" /]');
					$output .= '</div>';
				...
				$output .= '<div class="wdt-listings-item-top-section-content">';
					...
					$output .= '<div class="wdt-listings-utils-item-holder">';
						$output .= wdt_favourite_marker_html($listing_id);
						$output .= '<div class="wdt-listings-utils-item wdt-listings-utils-totalimages">';
							$output .= '<div class="wdt-listings-utils-totalimages-item"><a href="'.esc_url( get_permalink($listing_id) ).'"><span class="far fa-images"></span><p>'.esc_html($total_images_cnt).'</p></a></div>';
						$output .= '</div>';
					$output .= '</div>';
			...
			$output .= '<div class="wdt-listings-item-bottom-section">';
				...
				$output .= '<div class="wdt-listings-item-bottom-section-content">';
					...
					$output .= '<div class="wdt-listings-item-bottom-left-content">';
						...
						if(shortcode_exists('wdt_sp_price')) {
							$output .= do_shortcode('[wdt_sp_price listing_id="'.esc_attr($listing_id).'" type="listing" /]');
						}

					$output .= '</div>';

					$output .= '<div class="wdt-listings-item-bottom-right-content">';

						$output .= do_shortcode('[wdt_sp_features listing_id="'.esc_attr($listing_id).'" columns="-1" include="'.esc_attr($features_include).'" type="listing" features_image_or_icon="'.esc_attr($features_image_or_icon).'" /]');

					$output .= '</div>';

					$output .= do_shortcode('[wdt_sp_contact_details listing_id="'.esc_attr($listing_id).'" contact_details="list" include_email="true" include_phone="true" type="listing" /]');
					...
					if($custom_excerpt != '') {
						$output .= '<div class="wdt-listings-excerpt">';
							...
							$output .= '<p>';
								...
								if( get_post_meta($listing_id, 'wdt_excerpt_title', true) != '' ) {
									$output .= '<span>'.get_post_meta($listing_id, 'wdt_excerpt_title', true).'</span>';
								}
			...
			$output .= '<div class="wdt-listings-item-top-section">';
				...
				$output .= do_shortcode('[wdt_sp_taxonomy listing_id="'.esc_attr($listing_id).'" taxonomy="wdt_listings_category" type="type2" splice="'.esc_attr($no_of_cat_to_display).'" /]');
			...
			$output .= '<div class="wdt-listings-item-bottom-section">';
				...
				$output .= '<div class="wdt-listings-item-bottom-section-content">';
					...
					$output .= '<div class="wdt-listings-item-bottom-pricing-holder">';
			...
			$output .= '<div class="wdt-listings-item-bottom-section">';
				...
				$output .= do_shortcode('[wdt_sp_taxonomy listing_id="'.esc_attr($listing_id).'" taxonomy="wdt_listings_category" type="type3" splice="'.esc_attr($no_of_cat_to_display).'" /]');
					...
					if($custom_excerpt != '') {
						$output .= '<div class="wdt-listings-excerpt">';
							...
							$output .= '<p>';
								...
								if( get_post_meta($listing_id, 'wdt_excerpt_title', true) != '' ) {
									$output .= '<span>'.esc_html( get_post_meta($listing_id, 'wdt_excerpt_title', true) ).'</span>';
								}
			...
			$output .= '<div class="wdt-listings-item-top-section">';
				...
				$output .= do_shortcode('[wdt_sp_taxonomy listing_id="'.esc_attr($listing_id).'" taxonomy="wdt_listings_category" type="type4" splice="'.esc_attr($no_of_cat_to_display).'" /]');
			...
			$output .= '<div class="wdt-listings-item-top-section">';
				...
				$output .= do_shortcode('[wdt_sp_taxonomy listing_id="'.esc_attr($listing_id).'" taxonomy="wdt_listings_category" type="type5" splice="'.esc_attr($no_of_cat_to_display).'" /]');
			...
			$output .= '<div class="wdt-listings-item-bottom-section">';
                ...
                $output .= do_shortcode('[wdt_sp_taxonomy listing_id="'.esc_attr($listing_id).'" taxonomy="wdt_listings_category" type="type6" splice="'.esc_attr($no_of_cat_to_display).'" /]');
				...
				$output .= '<div class="wdt-listings-item-image-gallery" data-media-gallery="'.esc_js( wp_json_encode($wdt_media_galleries) ).'">';
					...
					$output .= '<div class="wdt-listings-view-details"><a class="wdt-listings-view-details-link" href="'.esc_url( get_permalink($listing_id) ).'"><i class="wdticon-eye"></i></a>';
					$output .= '</div>';
			...
			$output .= '<div class="wdt-listings-item-bottom-section">';
				...
				$output .= '<div class="wdt-listings-item-bottom-section-content">';
					...
					$output .= '<div class="wdt-listings-item-bottom-left-content">';
						$output .= do_shortcode('[wdt_sp_post_date listing_id="'.esc_attr($listing_id).'" with_label="true" type="listing" /]');
						$output .= do_shortcode('[wdt_sp_mls_number listing_id="'.esc_attr($listing_id).'" with_label="true" type="listing" /]');
					$output .= '</div>';
			...
			$output .= '<div class="wdt-listings-item-bottom-section">';
				...
				$output .= do_shortcode('[wdt_sp_taxonomy listing_id="'.esc_attr($listing_id).'" taxonomy="wdt_listings_category" type="type8" splice="'.esc_attr($no_of_cat_to_display).'" /]');
					...
					if($custom_excerpt != '') {
						$output .= '<div class="wdt-listings-excerpt">';
							...
							$output .= '<p>';
								...
								$wdt_excerpt_title = get_post_meta($listing_id, 'wdt_excerpt_title', true);

								if( $wdt_excerpt_title != '' ) {
									$output .= '<span>'.esc_html( $wdt_excerpt_title ).'</span>';
								}
					...
					if($custom_excerpt != '') {
						$output .= '<div class="wdt-listings-excerpt">';
							...
							$output .= '<p>';
								...
								if(  $wdt_excerpt_title != '' ) {
									$output .= '<span>'.$wdt_excerpt_title.'</span>';
								}
...
function wdt_listing_ajax_pagination($max_num_pages, $current_page, $function_call, $output_div, $item_ids) {
	...
	if($max_num_pages > 1) {
		...
		$output .= '<div class="wdt-pagination wdt-listing-pagination wdt-ajax-pagination"  data-functioncall="'.esc_attr( $function_call ).'" data-outputdiv="'.esc_attr( $output_div ).'" data-listing-options="'.esc_js($listing_options).'">';
...
if(!function_exists('breadcrumbs_portfolio_module')) {
    ...
    add_filter( 'xoha_breadcrumbs', 'breadcrumbs_portfolio_module', 10, 1 );
}
