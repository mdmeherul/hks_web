    ...
    <div class="wdt-single-header-area">
        <div class="wdt-column column no-space wdt-three-fifth wdt-image-area">
            <div class="wdt-column wdt-one-column first">
                <?php echo do_shortcode('[wdt_sp_media_images_list columns="3" include_featured_image="false" with_space="false" image_ids="1,2,3" listing_id="'.$listing_id.'"]'); ?>
            </div>
            <span class="wdt-empty-space-15"> </span>
            <div class="wdt-column wdt-one-column first">
                <?php echo do_shortcode('[wdt_sp_media_images_list columns="3" include_featured_image="false" with_space="false" image_ids="4,5,6" listing_id="'.$listing_id.'"]'); ?>
            </div>
        </div>
