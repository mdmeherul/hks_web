...
<div class="wdt-portfolio-single type1">
    ...
    <div class="wdt-single-image-area wdt-image-list-area"> 
        ...
        <div class="wdt-column wdt-one-half">
            <?php echo do_shortcode('[wdt_sp_media_images_list columns="1" include_featured_image="false" with_space="false" image_ids="4" listing_id="'.$listing_id.'"]'); ?>
            <span class="wdt-empty-space-15"> </span>
            <?php echo do_shortcode('[wdt_sp_media_images_list columns="2" include_featured_image="false" with_space="false" image_ids="5,6" listing_id="'.$listing_id.'"]'); ?>
        </div>
    </div>
