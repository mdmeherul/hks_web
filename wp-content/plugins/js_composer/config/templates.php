...
/* NAAPO */ 
if (!function_exists('naapo_studio_templates_for_vc') && defined('NOOK_PLG_PATH') && file_exists(NOOK_PLG_PATH."lib/naapo-studio/naapo-studio-templates.php")) 
	require_once(NOOK_PLG_PATH."lib/naapo-studio/naapo-studio-templates.php");
if (function_exists('naapo_studio_templates_for_vc')) naapo_studio_templates_for_vc();
