...
class Vc_Templates_Panel_Editor {
	...
	public function getAllTemplates() {
		...
		if ( ! empty( $default_templates ) ) {
			$arr_category = array(
				...
				'category_name' => __( 'Nook Templates', 'js_composer' ),
				'category_description' => __( 'Append predefined Naapo templates to the current layout', 'js_composer' ),
				'category_weight' => 10,
				/* NAAPO addition end*/
			);
			$category_templates = array();
	...
	public function renderTemplateListItem( $template ) {
		...
		/*NAAPO addition - adding in preview img*/
